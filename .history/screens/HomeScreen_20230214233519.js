...
const HomeScreen = () => {
  ...
  return (
    <SafeAreaView className="bg-white flex-1 relative">
      ...
      <View className="absolute bottom-20 w-24 h-24 border-l-2  border-t-4 border-r-2 border-[#00BCC9] rounded-full items-center justify-center">
       <TouchableOpacity>
       <Animatable.View animation={"pulse"} easing="ease-in-out" className="w-20 h-20 items-center justify-center rounded-full bg-[#00BCC9]">

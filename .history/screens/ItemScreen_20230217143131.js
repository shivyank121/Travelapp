      ...
      <ScrollView className="flex-1 px-4 py-6">
        ...
        <View className="mt-4 flex-row items-center justify-between">
          {data?.rating && (
            ...
            <View className="w-12 h-12 rounded-2xl bg-red-100 items-center shadow-md">
              <FontAwesome name="star" size={24} color="orange" />
            </View>
            <View>
            <Text className="text-lg font-bold text-[#2a2b4b] ">
                {data?.rating}
              </Text>
              <Text className="text-lg font-bold text-[#515151] ">
               Rating
              </Text>
            </View>
            </View>

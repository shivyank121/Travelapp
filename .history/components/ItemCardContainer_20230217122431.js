...
const ItemCardContainer = ({ imageSrc, title, rawranking, location,data }) => {
  ...
  return (
    ...
    className="rounded-lg border border-gray-300 space-y-2 px-2 py-2 shadow-md bg-white w-[200px] my-2">
      <Image
        source={{ uri: imageSrc }}
